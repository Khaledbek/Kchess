  ...
  Future<void> _requestBotMove() async {
    ...
    try {
      ...
      if (snapshot.isComplete && snapshot.move.isNotEmpty) {
        ...
        // The completed bot search is also the freshest evaluation of the
        // position after the human move. Keep the previous bar value visible
        // until this search finishes; never launch a second 3200-Elo job.
        if (_showEvaluationBar &&
            snapshot.evaluationFen == expectedFen &&
            (snapshot.evaluationCp != null ||
                snapshot.mateIn != null ||
                snapshot.wdl != null)) {
          setState(() {
            _evaluationLine = EngineLine(
              ...
              depth: 0,
              nodes: 0,
              moves: snapshot.bestMove.isEmpty
                  ? const []
                  : [snapshot.bestMove],
                      ...
                      SizedBox(
                        ...
                        child: evaluationVisible
                            ...
                            : _BotEvaluationPending(
                                thinking: _botThinking && _atLivePosition,
                              ),
                      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(strings.botGameSettingsDescription),
            const SizedBox(height: 14),
            SwitchListTile(
              ...
              subtitle: Text(strings.botGameEvaluationBarHelp),
