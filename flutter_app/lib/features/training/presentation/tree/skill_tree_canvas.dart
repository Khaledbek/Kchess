// -----------------------------------------------------------------------------
// Section: Interactive opening tree viewport
// -----------------------------------------------------------------------------
...
class _SkillTreeCanvasState extends State<SkillTreeCanvas>
  ...
  void _fit() {
    ...
    final target = (_viewportSize.width / controller.totalWidth)
  ...
  Widget _canvas(BuildContext context) {
    ...
    // Share one traversal between connector painting and visible card layout.
    final nodes = controller.visibleNodes.toList(growable: false);
  ...
  Widget _positioned(TreeLayoutNode node) {
    final progress = node.data.progress;
